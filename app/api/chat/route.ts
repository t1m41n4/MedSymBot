...
export async function POST(req: Request) {
  ...
  const result = streamText({
    model: openai("gpt-4o"),
    system: `You are MedSymBot, a helpful medical assistant chatbot for an online pharmacy called MedExpress.
    ...
    - When suggesting medications, mention that they are available on the MedExpress website
